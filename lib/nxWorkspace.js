...
const { readJsonFile } = require("@nrwl/workspace/src/utilities/fileutils");
 ...
 */
function determineNxPackages({ onlyAffected = true, cwd = process.cwd() }) {
	const nxJson = readNxJson();
	const gitArgs = { base: nxJson.affected.defaultBase || "master" };

	let projectGraph = createProjectGraph();
